...
INSERT INTO system_modules (id, name, parent_id, path, icon, allowed_actions, sort_order) VALUES
('ocr', 'OCR Intelligence', 'cat_config', '/config/ocr', 'LucideScanLine', ARRAY['VIEW'], 65)
