        ...
        <div class="space-y-4 mb-16 flex-grow">
          ...
          <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
              ...
              <tr><td class="p-3 text-[10px] font-bold">42</td><td class="p-3 text-[10px] font-black text-[#1E3A5F]">REG-2026-0275</td><td class="p-3 text-[10px] font-bold">{{ $t('upload.mock.manifest.item_42') }}</td><td class="p-3 text-[10px] font-bold">Operations</td><td class="p-3 text-[10px] font-bold">1</td><td class="p-3 text-[10px] font-bold">{{ $t('upload.form.urgency_levels.normal') }}</td></tr>
            </tbody>
          </table>
        </div>
...
const recents = [
  { id: 'INV-2023-0045', time: t('upload.mock.recents.two_hours_ago'), status: t('upload.mock.recents.approved'), statusBg: 'bg-green-50 text-green-500' },
  { id: 'PO-AKR-009', time: t('upload.mock.recents.yesterday'), status: t('upload.mock.recents.pending'), statusBg: 'bg-orange-50 text-orange-500' },
  { id: 'Travel_Budi', time: 'Oct 25', status: t('upload.mock.recents.draft'), statusBg: 'bg-slate-100 text-slate-500' }
]
</script>
